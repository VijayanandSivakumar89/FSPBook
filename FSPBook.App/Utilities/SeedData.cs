        ...
        public static void Seed(IServiceProvider serviceProvider)
        {
                    ...
                    DbContextOptions<Context>>()))
            {
                if (context.Profile.Count() == 0)
                {
                    ...
                    {
                        new Post { Id = 1, Content = exampleText, DateTimePosted = new DateTimeOffset(2020, 11, 1, 10, 0, 0, TimeSpan.Zero), ProfileId = 1 },
                        new Post { Id = 2, Content = exampleText, DateTimePosted = new DateTimeOffset(2020, 11, 1, 15, 0, 0, TimeSpan.Zero), ProfileId = 2 }
                    };
